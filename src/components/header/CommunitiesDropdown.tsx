...
const CommunitiesDropdown = ({ showCommunity }: { showCommunity: boolean }) => {
  ...
  return (
    ...
    >
      ...
      {isFetching && <div className="h-full flex flex-col items-center justify-center">Loading... <span className="animate-spin size-[20px] border-2 border-t-transparent border-white rounded-full"></span></div>}
